            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6">
              ...
              <div className="bg-[#f7f3f3] overflow-hidden md:flex-1">
                <div className="grid grid-cols-1">
                  <div className="aspect-[3/1] relative group/figma">
                    <ProjectImage src={imgErgoSkyApp} alt="Ergo Sky Productivity App" onClick={onImageClick} />
                    <a
                      href="https://www.figma.com/design/B8m5ixPS6miZK0Sbp7Tkzi/Furniture-Shopping?node-id=1-32&t=3kYBChMeIYcGoYdh-1"
                      target="_blank"
                      rel="noopener noreferrer"
                      onClick={(e: MouseEvent) => e.stopPropagation()}
                      className="absolute inset-0 flex items-center justify-center bg-black/50 opacity-0 group-hover/figma:opacity-100 transition-opacity duration-300"
                    >
                      <span className="flex items-center gap-2 bg-white text-[#2d2d2d] font-['Epilogue:SemiBold',sans-serif] text-[14px] px-4 py-2 rounded-full shadow-lg hover:bg-[#f0f0f0] transition-colors">
                  ...
                  <div className="aspect-[3/1] relative group/figma2">
                    <ProjectImage src={imgCryptoApp} alt="Crypto Trading App" onClick={onImageClick} />
                    <a
                      href="https://www.figma.com/design/3bAmReR0VkmGnwpOGdaleL/Crypto-Trading-App?node-id=1-3&t=O2sq93Q3BBL3xU9i-1"
                      target="_blank"
                      rel="noopener noreferrer"
                      onClick={(e: MouseEvent) => e.stopPropagation()}
                      className="absolute inset-0 flex items-center justify-center bg-black/50 opacity-0 group-hover/figma2:opacity-100 transition-opacity duration-300"
                    >
                      <span className="flex items-center gap-2 bg-white text-[#2d2d2d] font-['Epilogue:SemiBold',sans-serif] text-[14px] px-4 py-2 rounded-full shadow-lg hover:bg-[#f0f0f0] transition-colors">
                        <svg width="16" height="16" viewBox="0 0 38 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M19 28.5C19 25.9804 20.0009 23.5641 21.7825 21.7825C23.5641 20.0009 25.9804 19 28.5 19C31.0196 19 33.4359 20.0009 35.2175 21.7825C36.9991 23.5641 38 25.9804 38 28.5C38 31.0196 36.9991 33.4359 35.2175 35.2175C33.4359 36.9991 31.0196 38 28.5 38C25.9804 38 23.5641 36.9991 21.7825 35.2175C20.0009 33.4359 19 31.0196 19 28.5Z" fill="#1ABCFE"/>
